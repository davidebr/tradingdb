...
The simplest way to install TradingDB is using Pip.

.. code-block:: console

    $ pip install tradingdb

This will install ``tradingdb`` and all of its dependencies.
...
Report bugs at the `issue tracker <https://github.com/davidebr/tradingdb/issues>`_.
